...
export type AccentKey = "blue" | "teal" | "amber" | "green" | "violet";
...
/** One photograph in the gallery — EXIF carried like a dbt row's columns.
 *  src + dimensions are generated by scripts/optimize-photos.mjs; the rest is
 *  pulled from EXIF (and may be absent). Add human captions via PHOTO_META. */
export interface Photo {
  /** path under /public, e.g. /photography/01.jpg */
  src: string;
  /** intrinsic display dimensions — drive masonry aspect ratio, no layout shift */
  width: number;
  height: number;
  /** human caption / what it is (optional override) */
  title?: string;
  location?: string;
  /** camera body (from EXIF) */
  camera?: string;
  lens?: string;
  /** exposure line, e.g. "f/2.8 · 1/250s · ISO 200 · 35mm" */
  settings?: string;
  year?: string;
}
